...
- [ ] 2.2 Create `ansible/inventory/hosts.yml` and `ansible/group_vars/all/vars.yml`
- [ ] 2.3 Create `ansible/group_vars/all/vault.yml` (encrypted placeholder) and `ansible/group_vars/all/vault.yml.example`
