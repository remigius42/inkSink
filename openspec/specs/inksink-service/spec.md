...
Define how the `inksink` Ansible role deploys the application to the device,
including source synchronization, Python virtualenv, config templating, shell
wrapper, systemd service, and runtime data directory.
