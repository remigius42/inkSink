...
HTML-to-image renderer for e-ink display. Converts Anki card HTML to an
800×480 PIL image via `wkhtmltoimage`, supporting both 1-bit and 4-gray
modes, with in-memory LRU caching and temp-file cleanup.
