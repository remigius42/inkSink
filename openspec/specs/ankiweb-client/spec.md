...
AnkiWeb sync client for the inksink Anki app. Authenticates with AnkiWeb
using credentials from config and provides `sync_down()` / `sync_up()`
operations that synchronize the local Collection, gracefully skipping sync
