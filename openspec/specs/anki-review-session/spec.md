...
Interactive Anki review session for the e-ink display. Manages the full
review loop — sync on start, display card question/answer, record ratings,
show a summary, and sync on end — using in-memory session state and portrait
